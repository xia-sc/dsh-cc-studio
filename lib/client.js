      ...
      if(s.cur===0){
        ...
        main=h("div",null,
          h("div",{style:S.card},
            ...
            h("div",{style:{color:"var(--dsw-alias-label-secondary)", fontSize:12, marginBottom:10}},"每维填 1-2 句即可，CC 模式下 LLM 会通过工具引导你补全，并自动生成带 @@decorator 的 Lorebook。"),
            h("div",{style:{display:"grid", gridTemplateColumns:"1fr 1fr", gap:10}},
              h("div",{style:{border:"1px dashed var(--dsw-alias-border-l1)", borderRadius:12, padding:10, background:"var(--dsw-alias-bg-layer-1)"}}, h("div",{style:{fontSize:12, fontWeight:600, marginBottom:6}},"① 年表 Timeline"), h("textarea",{style:{width:"100%", boxSizing:"border-box", maxWidth:"100%", minHeight:70, background:"var(--dsw-alias-bg-base)", border:"1px solid var(--dsw-alias-border-l1)", borderRadius:8, color:"var(--dsw-alias-label-primary)", padding:"8px"}, value:s.world.timeline, onChange:function(e){ store.setWorldPatch("timeline", e.target.value); }})),
              h("div",{style:{border:"1px dashed var(--dsw-alias-border-l1)", borderRadius:12, padding:10, background:"var(--dsw-alias-bg-layer-1)"}}, h("div",{style:{fontSize:12, fontWeight:600, marginBottom:6}},"② 势力 Factions"), h("textarea",{style:{width:"100%", boxSizing:"border-box", maxWidth:"100%", minHeight:70, background:"var(--dsw-alias-bg-base)", border:"1px solid var(--dsw-alias-border-l1)", borderRadius:8, color:"var(--dsw-alias-label-primary)", padding:"8px"}, value:s.world.factions, onChange:function(e){ store.setWorldPatch("factions", e.target.value); }})),
              h("div",{style:{border:"1px dashed var(--dsw-alias-border-l1)", borderRadius:12, padding:10, background:"var(--dsw-alias-bg-layer-1)"}}, h("div",{style:{fontSize:12, fontWeight:600, marginBottom:6}},"③ 地理 Geography"), h("textarea",{style:{width:"100%", boxSizing:"border-box", maxWidth:"100%", minHeight:70, background:"var(--dsw-alias-bg-base)", border:"1px solid var(--dsw-alias-border-l1)", borderRadius:8, color:"var(--dsw-alias-label-primary)", padding:"8px"}, value:s.world.geo, onChange:function(e){ store.setWorldPatch("geo", e.target.value); }})),
              h("div",{style:{border:"1px dashed var(--dsw-alias-border-l1)", borderRadius:12, padding:10, background:"var(--dsw-alias-bg-layer-1)"}}, h("div",{style:{fontSize:12, fontWeight:600, marginBottom:6}},"④ 力量 Power"), h("textarea",{style:{width:"100%", boxSizing:"border-box", maxWidth:"100%", minHeight:70, background:"var(--dsw-alias-bg-base)", border:"1px solid var(--dsw-alias-border-l1)", borderRadius:8, color:"var(--dsw-alias-label-primary)", padding:"8px"}, value:s.world.power, onChange:function(e){ store.setWorldPatch("power", e.target.value); }})),
              h("div",{style:{border:"1px dashed var(--dsw-alias-border-l1)", borderRadius:12, padding:10, background:"var(--dsw-alias-bg-layer-1)", gridColumn:"span 2"}}, h("div",{style:{fontSize:12, fontWeight:600, marginBottom:6}},"⑤ 日常 Daily"), h("textarea",{style:{width:"100%", boxSizing:"border-box", maxWidth:"100%", minHeight:70, background:"var(--dsw-alias-bg-base)", border:"1px solid var(--dsw-alias-border-l1)", borderRadius:8, color:"var(--dsw-alias-label-primary)", padding:"8px"}, value:s.world.daily, onChange:function(e){ store.setWorldPatch("daily", e.target.value); }}))
            ),
        ...
        return h("div",{style:S.library},
          ...
          h("div",{style:{padding:"8px", borderBottom:"1px solid var(--dsw-alias-border-l1)", display:"flex", flexDirection:"column", gap:8, background:"var(--dsw-alias-bg-layer-1)"}},
            h("div",{style:{display:"flex", gap:6}},
              ...
              h("span",{style:{fontSize:11, color:"var(--dsw-alias-label-secondary)", alignSelf:"center"}}, s.draft.data.name ? s.draft.data.name.slice(0,10) : "未命名")
            ),
          ...
          h("div",{style:S.libraryList},
            ...
            filteredLibrary.map(function(entry){
              ...
              return h("div",{key:entry.id, style:S.libraryItem},
                ...
                h("div",{style:{fontSize:11, color:"var(--dsw-alias-label-secondary)", marginTop:4, whiteSpace:"nowrap", overflow:"hidden", textOverflow:"ellipsis"}}, entry.descriptionSnippet || entry.tags.join(" · ") || "—"),
    ...
    function SettingsView(props){
      ...
      return h("div",{style:{padding:"16px 20px", maxWidth:720}},
        ...
        h("div",{style:{marginTop:16, background:"var(--dsw-alias-bg-layer-1)", border:"1px solid var(--dsw-alias-border-l1)", borderRadius:12, padding:12}},
          ...
          h("div",{style:{fontSize:12, color:"var(--dsw-alias-label-primary)"}}, "原型对比：", h("a",{href:"file:///E:/dsh/plugin/dsh-cc-studio/prototypes/index.html", target:"_blank", style:{color:"#7c5cff"}}, "prototypes/index.html")),
          h("div",{style:{fontSize:12, color:"var(--dsw-alias-label-secondary)", marginTop:6}}, "首版仅 JSON，二期 CHARX/PNG + Assets。")
        )
      );
    }
