          ...
          (function(){
            ...
            return h("div",{style:{display:"flex", flexDirection:"column", padding:"8px 0", borderTop:"1px solid var(--dsw-alias-border-l1)", gap:8}},
              h("div",{style:{display:"flex", alignItems:"center", justifyContent:"space-between", gap:12}},
                h("div",{style:{flex:1, minWidth:0}},
                  h("div",{style:{fontSize:12, fontWeight:600, color:"var(--dsw-alias-label-primary)"}}, "CC 模式心跳同步"),
                  h("div",{style:{fontSize:11, color:"var(--dsw-alias-label-secondary)", marginTop:2, lineHeight:1.4}}, interval===0 ? "已关闭：CC 模式下不再自动拉取，胶囊需手动进工坊才同步。" : "每 "+interval+" 秒拉取一次草稿，LLM 写入后胶囊自动同步。可设 0 关闭。")
                ),
              ...
              pollEnabled ? h("div",{style:{display:"flex", alignItems:"center", gap:8}},
                h("span",{style:{fontSize:11, color:"var(--dsw-alias-label-secondary)"}}, "间隔"),
                ...
                h("span",{style:{fontSize:11, color:"var(--dsw-alias-label-secondary)"}}, "秒"),
                h("button",{style:Object.assign({}, S.btnGhost, {padding:"4px 8px", fontSize:11, border:"1px solid var(--dsw-alias-border-l1)"}), onClick:function(){ store.setPollInterval(4); }}, "重置 4s")
              ) : null
            );
          })(),
