          ...
          h("div",{style:S.card},
            ...
            h("div",{style:S.field},
              h("div",{style:{display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:4}},
                h("label",{style:{fontSize:12,color:"var(--dsw-alias-label-secondary)"}},"一句话点子"),
                h("button",{style:Object.assign({}, S.btnGhost, {padding:"2px 8px", fontSize:11, border:"1px solid var(--dsw-alias-border-l1)", background:"transparent", color:"var(--dsw-alias-label-primary)"}), onClick:function(){ store.setEditingText("一句话点子", s.idea, function(v){ store.setIdea(v); }); }}, "⛶ 大框")
              ),
              h("textarea",{style:{width:"100%", boxSizing:"border-box", maxWidth:"100%", minHeight:84, background:"var(--dsw-alias-bg-base)", border:"1px solid var(--dsw-alias-border-l1)", borderRadius:8, color:"var(--dsw-alias-label-primary)", padding:"8px 10px"}, value:s.idea, onChange:function(e){ store.setIdea(e.target.value); }})),
            ...
            h("div",{style:{marginTop:12, borderTop:"1px solid var(--dsw-alias-border-l1)", paddingTop:12}},
