  ...
  factory: (require) => {
    ...
    function Workshop(props){
      ...
      if(s.cur===0){
        ...
        main=h("div",null,
          h("div",{style:S.card},
            h("h3",{style:{margin:"0 0 8px", fontSize:13}},"校验与导出 — JSON / PNG / CHARX"),
    ...
    function SettingsView(props){
      ...
      return h("div",{style:{padding:"16px 20px", maxWidth:720}},
        ...
        h("div",{style:{marginTop:16, background:"var(--dsw-alias-bg-layer-1)", border:"1px solid var(--dsw-alias-border-l1)", borderRadius:12, padding:12}},
          ...
          h("div",{style:{fontSize:12, color:"var(--dsw-alias-label-secondary)", marginTop:6}}, "导入/导出：JSON / PNG(tEXt ccv3) / CHARX(ZIP card.json)，侧边栏 ★ 保存/载入/导出/删除。"),
