...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var S={
      ...
      workshop:{ width:"min(1360px, 96vw)", height:"min(860px, 92vh)", background:"linear-gradient(180deg,#171c2a,#11141d)", border:"1px solid #2a324b", borderRadius:18, overflow:"hidden", display:"flex", flexDirection:"column", boxShadow:"0 20px 80px rgba(0,0,0,.55)" },
      ...
      navBtn:{ width:"100%", boxSizing:"border-box", maxWidth:"100%", textAlign:"left", padding:"10px 12px", borderRadius:10, border:"1px solid transparent", background:"transparent", color:"#cbd5f0", cursor:"pointer" },
      navBtnActive:{ background:"#1a2140", borderColor:"#2d3a66", color:"white" },
      main:{ padding:"16px", overflow:"auto", minWidth:0 },
      side:{ borderLeft:"1px solid #242d47", background:"#0e1220", padding:"12px", overflow:"auto", minWidth:0 },
      ...
      libraryCollapsedBar:{ width:40, borderLeft:"1px solid rgba(42,50,75,.9)", background:"#0f1320", display:"flex", flexDirection:"column", alignItems:"center", padding:"10px 6px", gap:10, boxShadow:"inset 1px 0 0 rgba(42,50,75,.6)" },
      ...
      if(s.cur===0){
        main=h("div",null,
          h("div",{style:S.card},
            ...
            h("div",{style:S.field}, h("label",{style:{fontSize:12,color:"#9aa3b8"}},"一句话点子"), h("textarea",{style:{width:"100%", boxSizing:"border-box", maxWidth:"100%", minHeight:84, background:"#0b0f1b", border:"1px solid #26314d", borderRadius:8, color:"#e6e8ee", padding:"8px 10px"}, value:s.idea, onChange:function(e){ store.setIdea(e.target.value); }})),
            h("div",{style:S.field}, h("label",{style:{fontSize:12,color:"#9aa3b8"}},"风格标签（可多选 + 自定义）"),
              ...
              h("div",{style:{display:"flex", gap:6, marginTop:8}},
                h("input",{placeholder:"自定义标签，回车添加", style:{flex:1, background:"#0b0f1b", border:"1px solid #26314d", borderRadius:8, color:"#e6e8ee", padding:"6px 10px", fontSize:12, boxSizing:"border-box", maxWidth:"100%"}, value:s.customTag, onChange:function(e){ store.setCustomTag(e.target.value); }, onKeyDown:function(e){ if(e.key==="Enter"){ e.preventDefault(); store.addCustomTag(); }}}),
          ...
          h("div",{style:S.card},
            ...
            h("div",{style:S.field}, h("label",{style:{fontSize:12,color:"#9aa3b8"}},"personality"), h("textarea",{style:{width:"100%", boxSizing:"border-box", maxWidth:"100%", minHeight:72, background:"#0b0f1b", border:"1px solid #26314d", borderRadius:8, color:"#e6e8ee", padding:"8px 10px"}, value:s.draft.data.personality, onChange:function(e){ store.updateDraft(function(d){ d.personality=e.target.value; }); }})),
            h("div",{style:S.field}, h("label",{style:{fontSize:12,color:"#9aa3b8"}},"scenario"), h("textarea",{style:{width:"100%", boxSizing:"border-box", maxWidth:"100%", minHeight:72, background:"#0b0f1b", border:"1px solid #26314d", borderRadius:8, color:"#e6e8ee", padding:"8px 10px"}, value:s.draft.data.scenario, onChange:function(e){ store.updateDraft(function(d){ d.scenario=e.target.value; }); }}))
          )
        );
      } else if(s.cur===1){
        main=h("div",null,
          h("div",{style:S.card},
            ...
            h("div",{style:{display:"grid", gridTemplateColumns:"1fr 1fr", gap:10}},
              h("div",{style:{border:"1px dashed #2a3552", borderRadius:12, padding:10, background:"#0c1020"}}, h("div",{style:{fontSize:12, fontWeight:600, marginBottom:6}},"① 年表 Timeline"), h("textarea",{style:{width:"100%", boxSizing:"border-box", maxWidth:"100%", minHeight:70, background:"#0b0f1b", border:"1px solid #26314d", borderRadius:8, color:"#e6e8ee", padding:"8px"}, value:s.world.timeline, onChange:function(e){ store.setWorldPatch("timeline", e.target.value); }})),
              h("div",{style:{border:"1px dashed #2a3552", borderRadius:12, padding:10, background:"#0c1020"}}, h("div",{style:{fontSize:12, fontWeight:600, marginBottom:6}},"② 势力 Factions"), h("textarea",{style:{width:"100%", boxSizing:"border-box", maxWidth:"100%", minHeight:70, background:"#0b0f1b", border:"1px solid #26314d", borderRadius:8, color:"#e6e8ee", padding:"8px"}, value:s.world.factions, onChange:function(e){ store.setWorldPatch("factions", e.target.value); }})),
              h("div",{style:{border:"1px dashed #2a3552", borderRadius:12, padding:10, background:"#0c1020"}}, h("div",{style:{fontSize:12, fontWeight:600, marginBottom:6}},"③ 地理 Geography"), h("textarea",{style:{width:"100%", boxSizing:"border-box", maxWidth:"100%", minHeight:70, background:"#0b0f1b", border:"1px solid #26314d", borderRadius:8, color:"#e6e8ee", padding:"8px"}, value:s.world.geo, onChange:function(e){ store.setWorldPatch("geo", e.target.value); }})),
              h("div",{style:{border:"1px dashed #2a3552", borderRadius:12, padding:10, background:"#0c1020"}}, h("div",{style:{fontSize:12, fontWeight:600, marginBottom:6}},"④ 力量 Power"), h("textarea",{style:{width:"100%", boxSizing:"border-box", maxWidth:"100%", minHeight:70, background:"#0b0f1b", border:"1px solid #26314d", borderRadius:8, color:"#e6e8ee", padding:"8px"}, value:s.world.power, onChange:function(e){ store.setWorldPatch("power", e.target.value); }})),
              h("div",{style:{border:"1px dashed #2a3552", borderRadius:12, padding:10, background:"#0c1020", gridColumn:"span 2"}}, h("div",{style:{fontSize:12, fontWeight:600, marginBottom:6}},"⑤ 日常 Daily"), h("textarea",{style:{width:"100%", boxSizing:"border-box", maxWidth:"100%", minHeight:70, background:"#0b0f1b", border:"1px solid #26314d", borderRadius:8, color:"#e6e8ee", padding:"8px"}, value:s.world.daily, onChange:function(e){ store.setWorldPatch("daily", e.target.value); }}))
            ),
        ...
        main=h("div",null,
          h("div",{style:S.card}, h("h3",{style:{margin:"0 0 8px", fontSize:13}},"角色细化 — 六件套"),
            h("div",{style:{display:"grid", gridTemplateColumns:"1fr 1fr", gap:10}},
              h("div",{style:S.field}, h("label",{style:{fontSize:12,color:"#9aa3b8"}},"name"), h("input",{style:{width:"100%", boxSizing:"border-box", maxWidth:"100%", background:"#0b0f1b", border:"1px solid #26314d", borderRadius:8, color:"#e6e8ee", padding:"8px 10px"}, value:s.draft.data.name, onChange:function(e){ store.updateDraft(function(d){ d.name=e.target.value; }); }})),
              h("div",{style:S.field}, h("label",{style:{fontSize:12,color:"#9aa3b8"}},"nickname（{{char}} 用）"), h("input",{style:{width:"100%", boxSizing:"border-box", maxWidth:"100%", background:"#0b0f1b", border:"1px solid #26314d", borderRadius:8, color:"#e6e8ee", padding:"8px 10px"}, value:s.draft.data.nickname||"", onChange:function(e){ store.updateDraft(function(d){ d.nickname=e.target.value; }); }}))
            ),
            h("div",{style:S.field}, h("label",{style:{fontSize:12,color:"#9aa3b8"}},"tags（逗号分隔）"), h("input",{style:{width:"100%", boxSizing:"border-box", maxWidth:"100%", background:"#0b0f1b", border:"1px solid #26314d", borderRadius:8, color:"#e6e8ee", padding:"8px 10px"}, value:s.draft.data.tags.join(", "), onChange:function(e){ store.updateDraft(function(d){ d.tags=e.target.value.split(",").map(function(x){return x.trim();}).filter(Boolean); }); }})),
            h("div",{style:S.field}, h("label",{style:{fontSize:12,color:"#9aa3b8"}},"description"), h("textarea",{style:{width:"100%", boxSizing:"border-box", maxWidth:"100%", minHeight:84, background:"#0b0f1b", border:"1px solid #26314d", borderRadius:8, color:"#e6e8ee", padding:"8px 10px"}, value:s.draft.data.description, onChange:function(e){ store.updateDraft(function(d){ d.description=e.target.value; }); }})),
            h("div",{style:S.field}, h("label",{style:{fontSize:12,color:"#9aa3b8"}},"personality"), h("textarea",{style:{width:"100%", boxSizing:"border-box", maxWidth:"100%", minHeight:72, background:"#0b0f1b", border:"1px solid #26314d", borderRadius:8, color:"#e6e8ee", padding:"8px 10px"}, value:s.draft.data.personality, onChange:function(e){ store.updateDraft(function(d){ d.personality=e.target.value; }); }})),
            h("div",{style:S.field}, h("label",{style:{fontSize:12,color:"#9aa3b8"}},"scenario"), h("textarea",{style:{width:"100%", boxSizing:"border-box", maxWidth:"100%", minHeight:72, background:"#0b0f1b", border:"1px solid #26314d", borderRadius:8, color:"#e6e8ee", padding:"8px 10px"}, value:s.draft.data.scenario, onChange:function(e){ store.updateDraft(function(d){ d.scenario=e.target.value; }); }})),
            h("div",{style:{display:"grid", gridTemplateColumns:"1fr 1fr", gap:10}},
              h("div",{style:S.field}, h("label",{style:{fontSize:12,color:"#9aa3b8"}},"system_prompt"), h("textarea",{style:{width:"100%", boxSizing:"border-box", maxWidth:"100%", minHeight:72, background:"#0b0f1b", border:"1px solid #26314d", borderRadius:8, color:"#e6e8ee", padding:"8px 10px"}, value:s.draft.data.system_prompt||"", onChange:function(e){ store.updateDraft(function(d){ d.system_prompt=e.target.value; }); }})),
              h("div",{style:S.field}, h("label",{style:{fontSize:12,color:"#9aa3b8"}},"post_history_instructions"), h("textarea",{style:{width:"100%", boxSizing:"border-box", maxWidth:"100%", minHeight:72, background:"#0b0f1b", border:"1px solid #26314d", borderRadius:8, color:"#e6e8ee", padding:"8px 10px"}, value:s.draft.data.post_history_instructions||"", onChange:function(e){ store.updateDraft(function(d){ d.post_history_instructions=e.target.value; }); }}))
            )
          ),
          h("div",{style:S.card}, h("h3",{style:{margin:"0 0 8px", fontSize:13}},"开场与示例"),
            h("div",{style:S.field}, h("label",{style:{fontSize:12,color:"#9aa3b8"}},"first_mes"), h("textarea",{style:{width:"100%", boxSizing:"border-box", maxWidth:"100%", minHeight:72, background:"#0b0f1b", border:"1px solid #26314d", borderRadius:8, color:"#e6e8ee", padding:"8px 10px"}, value:s.draft.data.first_mes, onChange:function(e){ store.updateDraft(function(d){ d.first_mes=e.target.value; }); }})),
            h("div",{style:S.field}, h("label",{style:{fontSize:12,color:"#9aa3b8"}},"alternate_greetings（每行一条）"), h("textarea",{style:{width:"100%", boxSizing:"border-box", maxWidth:"100%", minHeight:72, background:"#0b0f1b", border:"1px solid #26314d", borderRadius:8, color:"#e6e8ee", padding:"8px 10px"}, value:s.draft.data.alternate_greetings.join("\n"), onChange:function(e){ store.updateDraft(function(d){ d.alternate_greetings=e.target.value.split("\n"); }); }})),
            h("div",{style:S.field}, h("label",{style:{fontSize:12,color:"#9aa3b8"}},"group_only_greetings *必填"), h("textarea",{style:{width:"100%", boxSizing:"border-box", maxWidth:"100%", minHeight:60, background:"#0b0f1b", border:"1px solid #26314d", borderRadius:8, color:"#e6e8ee", padding:"8px 10px"}, value:s.draft.data.group_only_greetings.join("\n"), onChange:function(e){ store.updateDraft(function(d){ d.group_only_greetings=e.target.value.split("\n"); }); }})),
            h("div",{style:S.field}, h("label",{style:{fontSize:12,color:"#9aa3b8"}},"mes_example（{{user}}/{{char}}）"), h("textarea",{style:{width:"100%", boxSizing:"border-box", maxWidth:"100%", minHeight:96, background:"#0b0f1b", border:"1px solid #26314d", borderRadius:8, color:"#e6e8ee", padding:"8px 10px"}, value:s.draft.data.mes_example, onChange:function(e){ store.updateDraft(function(d){ d.mes_example=e.target.value; }); }}))
          )
        );
      } else if(s.cur===3){
        ...
        main=h("div",null,
          h("div",{style:S.card},
            ...
            h("div",{style:S.field}, h("label",{style:{fontSize:12,color:"#9aa3b8"}},"creator_notes / 多语言"), h("textarea",{style:{width:"100%", boxSizing:"border-box", maxWidth:"100%", minHeight:60, background:"#0b0f1b", border:"1px solid #26314d", borderRadius:8, color:"#e6e8ee", padding:"8px 10px"}, value:s.draft.data.creator_notes, onChange:function(e){ store.updateDraft(function(d){ d.creator_notes=e.target.value; }); }})),
            h("div",{style:{display:"grid", gridTemplateColumns:"1fr 1fr", gap:10}},
              h("div",{style:S.field}, h("label",{style:{fontSize:12,color:"#9aa3b8"}},"creation_date"), h("input",{style:{width:"100%", boxSizing:"border-box", maxWidth:"100%", background:"#0b0f1b", border:"1px solid #26314d", borderRadius:8, color:"#e6e8ee", padding:"8px 10px"}, value:String(s.draft.data.creation_date), readOnly:true})),
              h("div",{style:S.field}, h("label",{style:{fontSize:12,color:"#9aa3b8"}},"modification_date（导出自动刷新）"), h("input",{style:{width:"100%", boxSizing:"border-box", maxWidth:"100%", background:"#0b0f1b", border:"1px solid #26314d", borderRadius:8, color:"#e6e8ee", padding:"8px 10px"}, value:String(s.draft.data.modification_date), readOnly:true}))
            ),
            s.lastMsg? h("div",{style:{marginTop:8, fontSize:12, color:"#aebde0"}}, s.lastMsg):null
          )
        );
      ...
      function renderLibrary(){
        if(s.libraryCollapsed){
          return h("div",{style:S.libraryCollapsedBar},
            h("button",{style:Object.assign({}, S.btnGhost, {border:"1px solid #2a324b", background:"transparent", color:"#e6e8ee", borderRadius:8, padding:"6px 8px", fontSize:12, cursor:"pointer", width:28, height:28, display:"flex", alignItems:"center", justifyContent:"center"}), onClick:function(){ store.toggleLibraryCollapsed(); }, title:"展开已存角色"}, "◀"),
            h("div",{style:{writingMode:"vertical-rl", fontSize:12, color:"#9aa3b8", letterSpacing:2, lineHeight:"16px"}}, "已存 "+s.library.length),
        ...
        return h("div",{style:S.library},
          ...
          h("div",{style:{padding:"8px", borderBottom:"1px solid #242d47", display:"flex", flexDirection:"column", gap:8, background:"#0f1320"}},
            ...
            h("input",{placeholder:"搜索 名称/标签…", style:{width:"100%", boxSizing:"border-box", maxWidth:"100%", background:"#0b0f1b", border:"1px solid #26314d", borderRadius:8, color:"#e6e8ee", padding:"6px 8px", fontSize:12}, value:s.libraryQuery, onChange:function(e){ store.setLibraryQuery(e.target.value); }}),
